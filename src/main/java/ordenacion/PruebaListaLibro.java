...
public class PruebaListaLibro {
    ...
    public static void main(String[] args) {
        ...
        catalogo.insertarLibro(new Libro("1234a", "la muerte a pellizcos", "Planeta", 10, 0.9));
        catalogo.insertarLibro(new Libro("1234c", "la muerte a bocados", "Planeta", 10, 0.19));
        catalogo.insertarLibro(new Libro("1235b", "la muerte a bocados", "Planeta", 10, 0.92));
        catalogo.insertarLibro(new Libro("1236d", "la muerte a bocados", "Planeta", 10, 0.29));
